...
The objective of this lab was to process digital evidence in a manner that supports integrity, repeatability, proper evidence handling, and the reliability considerations associated with the **Daubert Standard**.
...
| Tool | Purpose |
|---|---|
| **FTK Imager** | Loaded the forensic image, reviewed files, recovered deleted evidence, exported files, and generated MD5/SHA-1 hash reports |
...
5. Generate MD5 and SHA-1 hashes.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/6821c16b-239c-4e48-9a39-7985e5cb0ec5"
       alt="Search warrant identifying the authorized scope of the forensic examination"
       width="750">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/7f400d80-b816-4647-899b-06cab17cf55a"
       alt="Completed chain-of-custody evidence transfer form"
       width="550">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/523359dc-ea1d-4388-9c84-b265ecde4247"
       alt="FTK Imager with Evidence_drive1.001 loaded as an evidence source"
       width="650">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/23ebff8b-9612-4431-95fd-6a089dc25715"
       alt="FTK Imager showing suspicious file 0002665 in NTFS unallocated space"
       width="750">
</p>

#### Hash Report for File 0002665

FTK Imager generated a CSV report containing the evidence filename, file location, MD5 value, and SHA-1 value.

<p align="center">
  <img src="https://github.com/user-attachments/assets/336119fe-06fb-4cf2-af32-6d840904e9c4"
       alt="FTK Imager CSV hash report for file 0002665"
       width="750">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/e0884e08-5633-4c4f-b558-4b69b2e560eb"
       alt="FTK Imager showing Recycle Bin metadata for deleted evidence"
       width="49%">
  <img src="https://github.com/user-attachments/assets/bf512a26-6c0f-4238-a9f0-f2e038a256d5"
       alt="FTK Imager showing deleted Recycle Bin content associated with MyRussianMafiaBuddies.txt"
       width="49%">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/92a833a1-a90e-4a53-b73b-ab0e98e49853"
       alt="FTK Imager showing suspicious files in the Temp Folder"
       width="750">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/1b327a48-7020-444e-95cc-0d11587b65ed"
       alt="FTK Imager hash report for MyRussianMafiaBuddies.txt"
       width="750">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/8aad3b34-56f1-4755-964f-df24038d6842"
       alt="FTK Imager hash report for Nice Guys.png"
       width="750">
</p>
...
I imported the same forensic image into Paraben E3 and located the previously identified evidence. I then compared the MD5 and SHA-1 values generated by E3 with the values produced by FTK Imager.

#### Verification Result

The MD5 and SHA-1 values generated by E3 matched the values generated by FTK Imager for both identified evidence files.
...
- The compared file contents remained unchanged between the FTK Imager and E3 examinations.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/4b3ac30f-8e17-4044-9270-c89a2c42f005"
       alt="Paraben E3 hash values for MyRussianMafiaBuddies.txt"
       width="750">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/bb35a630-0744-4227-b9d8-c69a0121a43f"
       alt="Paraben E3 hash values for Nice Guys.png"
       width="750">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/32fd5ba9-18c4-4837-b5a7-4eb82430c9a6"
       alt="FTK Imager showing the suspicious email evidence"
       width="750">
</p>
...
| Evidence Object | MD5 |
|---|---|
| Original `.eml` file | `b0eca56883fd0a95d5a1885162b278ec` |
| Modified `.eml` file | `a3daacbbf684478785cc3fef257fc727` |
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/73be6ed3-b8ff-4566-b80c-d386fb9fcb39"
       alt="FTK Imager MD5 comparison for the original and modified email files"
       width="800">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/60a74587-f07b-4cf7-8952-fd4b26ef57f9"
       alt="Autopsy showing the MD5 value for the selected Stardust image attachment"
       width="800">
</p>
...
The value did not match either FTK Imager `.eml` hash shown above or the Autopsy value associated with the selected image attachment.
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/20fc2377-f586-4b05-8c30-ddd0b5c0421e"
       alt="Paraben E3 showing the MD5 value for the selected email evidence"
       width="800">
</p>
...
I used the FTK Imager command-line utility to generate MD5 and SHA-1 values for:
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/4f6a63b2-7ee0-4011-930a-2112e3c41d6e"
       alt="FTK Imager command-line verification results for Evidence_drive1.001"
       width="800">
</p>
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/7b33f553-0de5-43bd-a0d8-4191685f0b81"
       alt="FTK Imager showing Recycle Bin metadata for DrugSales.xlsx"
       width="800">
  <br><br>
  <img src="https://github.com/user-attachments/assets/4e6c0a77-46d6-4c46-96c3-a2f0305dd647"
       alt="FTK Imager showing Recycle Bin metadata for manual-testing-fresher-resume-1.doc"
       width="800">
  <br><br>
  <img src="https://github.com/user-attachments/assets/49aedb53-daab-4617-bc4d-03f94e342a40"
       alt="FTK Imager showing Recycle Bin metadata for hr letter for visa.pdf"
       width="800">
</p>
...
- The search warrant established the authorized search scope, while the chain-of-custody form documented the evidence transfer and handling history.
...
- MD5 and SHA-1 values from FTK Imager and Paraben E3 matched when the exact same files were examined.
...
This lab demonstrated several practices that support the reliability considerations associated with the Daubert Standard:
...
- **Integrity verification:** Matching hashes demonstrated that the compared file contents had not changed between examinations.
- **Reproducibility:** Another examiner using the same evidence and method should be able to reproduce the same hash results.

These practices support the reliability of the forensic process, but they do not by themselves determine courtroom admissibility.
...
The lab showed that forensic findings must be supported by repeatable methods and careful documentation. Matching hashes can support evidence integrity for the compared objects, while mismatched hashes require the examiner to determine whether the file was modified or whether different evidence objects were selected.
